...
filepath = 'D:/DISEASE DETECTION AND PREVENTION/Plant-Leaf-Disease-Prediction/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:/DISEASE DETECTION AND PREVENTION/Plant-Leaf-Disease-Prediction/static/upload/', filename)
        file.save(file_path)
